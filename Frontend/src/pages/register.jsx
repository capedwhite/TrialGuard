    ...
    <div className="min-h-screen bg-black flex">
      <div className="hidden lg:flex lg:w-1/2 bg-zinc-950 border-r border-zinc-900 
        ...
        <div>
          <h2 className="text-4xl font-bold text-white leading-tight mb-4">
            Take <span className="text-red-500">Control</span> of<br />
            Your Free<br />Trials Today
          </h2>
          <p className="text-zinc-400 text-sm leading-relaxed max-w-sm">
            Join thousands of users who never get surprised by
            unexpected charges. Set it up in minutes.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-zinc-500 text-sm mb-8">Start tracking your free trials for free</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            >
              {isPending ? 'Creating account...' : 'Start Tracking for Free'}
            </button>
          </form>
